  ...
  return (
    <header className="py-6 @laptop:py-5">
      <ContainerGrid className="flex items-center justify-between">
        ...
        <button className="w-10 h-10 flex items-center justify-center border border-white border-opacity-5 rounded bg-white bg-opacity-5 @laptop:hidden @desktop:hidden">
